        ...
        <b-card class="mb-30">
          <b-row align-v="center">
            ...
            <b-col md="1" class="mt-3 mt-md-0" v-if="totalRecords>0">
              <router-link :to="'/admin-api/export/exportBonus?token='+adminToken+'&username='+searchUsername+'&bonus=sponsor_bonus&from='+from+'&to='+to+''" target="_blank">
                  {{$t("export")}}
              </router-link>
...
<script>
import { getBonusRecord,getExportBonus } from "../../../system/api/api";
