<template>
  <div class="main-content">
    <breadcumb :page="$t('dynamic_bonus')" :folder="$t('bonusRecord')" />
    <b-row>
      <b-col md="12">
        <b-card class="mb-30">
          <b-row align-v="center">
            ...
            <b-col md="1" class="mt-3 mt-md-0" v-if="totalRecords>0">
              <router-link :to="'/admin-api/export/exportBonus?token='+adminToken+'&username='+searchUsername+'&bonus=dynamic_bonus&from='+from+'&to='+to+''" target="_blank">
                  {{$t("export")}}
              </router-link>
