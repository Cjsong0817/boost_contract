        ...
        <b-card class="mb-30">
          <b-row align-v="center">
            ...
            <b-col md="1" class="mt-3 mt-md-0" v-if="totalRecords>0">
              <router-link :to="'/admin-api/export/exportWithdrawHis?token='+adminToken+'&username='+searchUsername+'&from='+from+'&to='+to+''" target="_blank">
                  {{$t("export")}}
              </router-link>
          ...
          <!--<span v-else-if="props.column.field == 'address'">
            ...
            >
              <span
                ...
                v-b-popover.hover.bottom="props.row.address"
              >
                {{
                  props.row.address.substring(0, props.row.address.length / 2)
                }}
              </span>
              <span
                style="font-weight: 600; color: #3498db"
                v-b-popover.hover.bottom="props.row.address"
              >
                {{ props.row.address.substring(props.row.address.length / 2) }}
              </span>
            </div>
          </span>-->
        </template>
