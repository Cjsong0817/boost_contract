<template>
            ...
            <b-col md="12">
              <b-card class="mb-30">
                <b-row align-v="center">
                  <b-col md="2">
                    <b-form-group id="input-group-1" label="UID" label-for="input-1">
                      <b-form-input id="input-1" type="text" required :placeholder="$t('Enter') + 'UID'"
                        v-model="searchUID"></b-form-input>
                    </b-form-group>
                  </b-col>
                  ...
                  <b-col md="2" class="mt-3 mt-md-0">
                    <b-form-group id="input-group-2" :label="$t('mobile')" label-for="input-2">
                      <b-form-input id="input-2" type="text" required :placeholder="$t('Enter') + $t('mobile')"
                        v-model="searchPhone"></b-form-input>
                    </b-form-group>
                  </b-col>
                  ...
                  <b-col md="2" class="mt-3 mt-md-0">
                    <b-form-group
                      id="input-group-2"
                      :label="$t('shidan_kongdan')"
                      label-for="input-2"
                    >
                     <b-form-select v-model="searchDan" :options="danOptions" >
                        </b-form-select>
                    </b-form-group>
                  </b-col>
                  ...
                  <b-col md="1" class="mt-3 mt-md-0">
                    <router-link
                      :to="'/admin-api/export/exportUser?token=' + adminToken + '&username=' + searchUsername + '&id=' + searchUID + '&contact_number=' + searchPhone + ''"
                      target="_blank">
                      {{ $t("export") }}
                    </router-link>
  ...
  selectionInfoClass: 'table-alert__box',
            ...
            <template slot="table-row" slot-scope="props">
              ...
              <span v-else-if="props.column.field == 'user_group_id'">
                ...
                <span v-if="$i18n.locale == 'en'">
                  {{ props.row.package.package_name_en + checkPackage(props.row.package.remark) }}
                </span>
                <span v-else>{{ props.row.package.package_name + checkPackage(props.row.package.remark) }}</span>
              </span>
              ...
              <span v-else-if="props.column.field == 'jy'">
                <span v-if="props.row.jy" style="color: green">
                  <i class="fa fa-check"></i>
                </span>
                <span v-else style="color: red">
                  <i class="fa fa-remove"></i>
              ...
              <span v-else-if="props.column.field == 'rg'">
                <span v-if="props.row.rg" style="color: green">
                  <i class="fa fa-check"></i>
                </span>
                <span v-else style="color: red">
                  <i class="fa fa-remove"></i>
              ...
              <span v-else-if="props.column.field == 'action'">
                <button type="button" class="btn btn-default btn-edit" v-b-popover.hover.top="$t('editUser')"
                  @click="editUser(props.row)">
                  <i class="fa fa-pencil"></i>
                </button>
                <button type="button" class="btn btn-default btn-push mx-1 px-2" v-b-popover.hover.top="$t('updatePwd')"
                  @click="showModal(props.row)">
                  <i class="fa fa-shield"></i>
                </button>
                <button type="button" class="btn btn-default btn-wallet mr-1" v-b-popover.hover.top="$t('walletRecord')"
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-end">
              ...
              <b-input-group class="ml-3" style="width: 160px">
                ...
                <b-input-group-append>
                  <b-button variant="primary" @keypress="loadItems()" @click="loadItems()">{{ $t("go") }}</b-button>
                </b-input-group-append>
              </b-input-group>
            </div>
          </div>
      ...
      <b-tab :title="$t('editUser')" :title-item-class="{ hiddenClass: !canEdit }">
            ...
            <b-col md="8 mb-30">
              <b-form v-on:submit.prevent="updateUser">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="d_password" v-model="password" readonly />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <b-form-select v-model="packageType" :options="selectOptions" id="package">
                    </b-form-select>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="special" class="col-sm-2 col-form-label">{{
                    $t("special")
                  }}</label>
                  <div class="col-sm-10">
                    <b-form-select v-model="special" :options="specialOptions" id="special">
                    </b-form-select>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="user_rank" class="col-sm-2 col-form-label">{{
                    $t("user_rank")
                  }}</label>
                  <div class="col-sm-10">
                    <b-form-select v-model="user_rank_id" :options="user_rank_idOptions" id="user_rank">
                    </b-form-select>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <b-form-select v-model="set_rank" :options="user_rank_idOptions" id="set_rank">
                    </b-form-select>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="total_cap" class="col-sm-2 col-form-label">{{
                    $t("total_cap")
                  }}</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="total_cap" v-model="total_cap" />
                  </div>
                </div>
                <div class="form-group row">
                  <label for="auto_renew" class="col-sm-2 col-form-label">{{
                    $t("auto_renew")
                  }}</label>
                ...
                <div class="form-group row">
                  <label for="jy" class="col-sm-2 col-form-label">{{
                    $t("jy")
                  }}</label>
                  <div class="col-sm-10 py-2">
                    <label class="switch switch-primary mr-3">
                      <input type="checkbox" v-model="jy" />
                      <span class="slider"></span>
                    </label>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="rg" class="col-sm-2 col-form-label">{{
                    $t("register")
                  }}</label>
                  <div class="col-sm-10 py-2">
                    <label class="switch switch-primary mr-3">
                      <input type="checkbox" v-model="rg" />
                      <span class="slider"></span>
                    </label>
                  </div>
                </div>
      ...
      <b-tab :title="$t('walletRecord') + '(' + searchUsernameWallet + ')'"
        ...
        <b-row>
          <b-col md="12">
            <b-card class="mb-30">
              <b-row align-v="center">
                <b-col md="2" class="mt-3 mt-md-0">
                  <b-form-group id="walletType" :label="$t('wallet')" label-for="walletType">
                    <b-form-select v-model="selectWalletType" :options="walletOptions"
                      @change="showWallet(searchUsernameWallet)" id="walletType">
                    </b-form-select>
                  </b-form-group>
                </b-col>
        ...
        <b-card :title="$t('totalBalance') + totalBalance">
          <vue-good-table id="table" mode="remote" @on-page-change="onWalletPageChange" @on-search="onSearch"
            :totalRows="totalWalletRecords" :isLoading="isLoading" :columns="walletLabel" :search-options="{
              enabled: false,
              placeholder: 'Search this table',
            }" :pagination-options="{
  enabled: false,
  ...
  selectionInfoClass: 'table-alert__box',
        ...
        <b-button variant="primary" class="btn-rounded"> Add Button </b-button>
          ...
          <div class="align-items-center mobile-adjust">
            <div v-if="totalWalletRecords > 0" class="
                d-flex
                flex-wrap
                align-items-center
                justify-content-start
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-end">
              <b-pagination class="pagi-margin pt-3" v-model="walletPageNumber" :total-rows="totalWalletRecords"
                :per-page="10" :first-text="$t('first')" :prev-text="$t('prev')" :next-text="$t('next')"
                :last-text="$t('last')" @input="getWRecord">
              </b-pagination>

              <b-input-group class="ml-3" style="width: 160px">
                <b-form-input v-model="walletPageNumber" :placeholder="$t('PageNo')"></b-form-input>
                <b-input-group-append>
                  <b-button variant="primary" @keypress="getWRecord" @click="getWRecord">{{ $t("go") }}</b-button>
                </b-input-group-append>
              </b-input-group>
            </div>
          </div>
            ...
            <b-col md="12 mb-30">
              <b-form v-on:submit.prevent="updateSettings">
                ...
                >
                  ...
                  <div class="col-sm-3">
                    <b-form-select
                      v-model="form.setting[index]['product_id']"
    ...
    <b-modal id="modal-1" size="md" centered :title="$t('updatePwd')" :hide-footer="true">
      <b-tabs pills>
            ...
            <b-row align-h="center">
              <b-col md="12 my-30">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="title2" v-model="username" readonly />
                  </div>
                </div>
                <div class="form-group row">
            ...
            <b-row align-h="center">
              <b-col md="12 my-30">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password" v-model="password2" required />
                  </div>
                </div>
                <div class="form-group row justify-content-end">
                  <div class="col-sm-12">
  ...
  data() {
    return {
      ...
      danOptions: [
        ...
        { value: "1", text: this.$t("shidan") },
        { value: "2", text: this.$t("kongdan") },
      ],
    };
  },
  methods: {
    ...
    showSettings(id, setting) {
      ...
      if (setting == null) {
        ...
        // this.user_setting = setting.split(/[ ,]+/);
        // var thenew = this.user_setting.splice(0);

        // var regex = /\d+/g;
        // var string = thenew.toString();
        // var matches = string.match(regex);

        // // var newNumber = thenew.toString().replace(/[']/g, '');
        // // console.log(this.user_setting);
        // console.log(matches + "wtf");
        // // console.log(newNumber.split(/ ,+/));
        // console.log(thenew[0]);
        // for (let i = 0; i < 60; i++) {
        //   this.setting[i] = matches[i];
        // }
      }
    },
    getWRecord() {
    ...
    editUser(row) {
      ...
      self.username = contentData.username;
      self.fullname = contentData.fullname;
      self.email = contentData.email;
      self.contact_number = contentData.contact_number;
      self.country = contentData.country.id;
      self.special = contentData.special;
      self.user_rank_id = contentData.user_rank_id;
      self.set_rank = contentData.set_rank;
      self.total_cap = contentData.total_cap;
      ...
      self.jy = contentData.jy == 1 ? true : false;
      self.rg = contentData.rg == 1 ? true : false;
      self.auto_renew = contentData.auto_renew == 1 ? true : false;
    },
    updatePwd() {
    ...
    updateUser() {
      ...
      formData.append("user_rank_id", this.user_rank_id);
      formData.append("set_rank", this.set_rank);
      formData.append("total_cap", this.total_cap);
      ...
      formData.append("jy", this.jy ? 1 : 0);
      formData.append("wt", this.wt ? 1 : 0);
      formData.append("rg", this.rg ? 1 : 0);
      ...
      result
        .then(function (value) {
          ...
          for (let i = 0; i < self.package.length; i++) {
            ...
            jsonPackage["text"] = self.package[i].package_name + (self.package[i].remark == null ? '' : self.package[i].remark);
          ...
          for (let i = 0; i < self.product.length; i++) {
            ...
            jsonProduct["text"] =
              "(" + self.product[i].price + ") " + self.product[i].name_en + (self.package[i].remark == null ? '' : self.package[i].remark);
