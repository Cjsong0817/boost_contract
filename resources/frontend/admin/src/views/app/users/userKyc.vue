<template>
  <div class="main-content">
    <breadcumb :page="$t('user_kyc')" :folder="$t('userManage')" />
      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field == 'action'">
            ...
            <span v-else-if="props.column.field == 'ic_front'">
                <span v-if="props.row.ic_front!=null">
                  <router-link :to="'/storage'+props.row.ic_front" target="_blank">
                     <img :src="get_current_url +'/storage'+props.row.ic_front" height="50">
                  </router-link>
               
                    <!-- <button
                    class="my-auto mx-2"
                    type="button"
                    v-clipboard="() => get_current_url +'/storage'+props.row.ic_front"
            ...
            <span v-else-if="props.column.field == 'ic_back'">
                <span v-if="props.row.ic_back!=null">
                  <router-link :to="'/storage'+props.row.ic_back" target="_blank">
                     <img :src="get_current_url +'/storage'+props.row.ic_back" height="50">
                  </router-link>
                    <!-- <button
                    class="my-auto mx-2"
                    type="button"
                    v-clipboard="() => get_current_url +'/storage'+props.row.ic_back"
                    v-clipboard:success="clipboardSuccessHandler"
                    v-clipboard:error="clipboardErrorHandler"
                    >
                    <span>{{ $t("copy") }}</span>
            ...
            <span v-else-if="props.column.field == 'passport'">
                <span v-if="props.row.passport!=null">
                   <router-link :to="'/storage'+props.row.ic_front" target="_blank">
                     <img :src="get_current_url +'/storage'+props.row.passport" height="50">
                  </router-link>
                
                    <!-- <button
                    class="my-auto mx-2"
                    type="button"
                    v-clipboard="() => get_current_url +'/storage'+props.row.passport"
                    v-clipboard:success="clipboardSuccessHandler"
                    v-clipboard:error="clipboardErrorHandler"
                    >
                    <span>{{ $t("copy") }}</span>
...
export default {
  ...
  methods: {
    ...
    approved(row) {
      ...
      var result = kycControl(formData);
      var self = this;
      result
        .then(function (value) {
    ...
    loadItems() {
     this.get_current_url = window.location.origin;
      var result = getKycList(
        this.pageNumber,
        this.from,
        this.to,
        this.searchUsername
