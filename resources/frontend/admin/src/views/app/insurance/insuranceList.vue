<template>
  <div class="main-content">
    <breadcumb :page="$t('claim_list')" :folder="$t('insuranceManage')" />
    ...
    <b-tabs pills align="end" v-model="tabIndex">
      ...
      <b-tab
        :title="$t('insurance') + '(' + searchUsernameWallet + ')'"
            ...
            >
              ...
              <b-input-group class="ml-3" style="width: 160px">
                ...
                <b-input-group-append>
                  <b-button
                    variant="primary"
                    @keypress="_getBetRecordList"
                    @click="_getBetRecordList"
                    >{{ $t("go") }}</b-button
                  >
                </b-input-group-append>
              </b-input-group>
