...
export function getUserInfo(username) {
	const data = request({
		url: current + 'admin-api/user/get_user_info?username='+username,
		method: 'get',
		headers: retHeader()
	});
...
export function getPackage() {
	const data = request({
		url: current + 'admin-api/package/getPackage',
		method: 'get',
		headers: retHeader()
	});
...
export function addPackage(postData) {
	const data = request({
		url: current + 'admin-api/package/addPackage',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function userWalletRecord(page, search) {
	const data = request({
		url: current + 'admin-api/record/userWalletRecord?page=' + page + search,
		method: 'get',
		// data: postData,
		headers: retHeader()
	});
...
export function getUserList(postData, username, dan, phone, uid) {
	const data = request({
		url: current + 'admin-api/user/user_list?page=' + postData + '&username=' + username + '&dan=' + dan + '&mobile_no=' + phone + '&uid=' + uid,
		method: 'get',
		// data: postData,
		headers: retHeader()
	});
...
export function batchWithdrawControl(postData) {
	const data = request({
		url: current + 'admin-api/wallet/batchWithdrawControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function getKycList(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/user/kycList?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function kycHis(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/user/kycHis?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function kycControl(postData) {
	const data = request({
		url: current + 'admin-api/user/kycControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function surenderRecord(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/surenderRecord?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function surenderHis(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/surenderHis?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function surenderControl(postData) {
	const data = request({
		url: current + 'admin-api/insurance/surenderControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function followList(type, pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/followList?page=' + pageNumber + '&request_type=' + type + '&username=' + username + '&from=' + from + '&to=' + to,
		method: 'get',
		headers: retHeader()
	});
...
export function followControl(postData) {
	const data = request({
		url: current + 'admin-api/insurance/followControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function revertRecord(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/revertRecord?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function revertControl(postData) {
	const data = request({
		url: current + 'admin-api/insurance/revertControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function followerClaim(postData) {
	const data = request({
		url: current + 'admin-api/insurance/followerClaim',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function getClaimList(pageNumber, from, to, username, claim_type) {
	const data = request({
		url: current + 'admin-api/insurance/claimHis?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username + '&claim_type=' + claim_type,
		method: 'get',
		headers: retHeader()
	});
...
export function followerUserList(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/followerUserList?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function claimHis(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/claimHis?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function claimControl(postData) {
	const data = request({
		url: current + 'admin-api/insurance/claimControl',
		method: 'post',
		data: postData,
		headers: retHeader()
	});
...
export function packageRecord(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/record/userPackageRecord?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function getBetRecordList(pageNumber, from, to, username) {
	const data = request({
		url: current + 'admin-api/insurance/insuranceBetRecord?page=' + pageNumber + '&from=' + from + '&to=' + to + '&username=' + username,
		method: 'get',
		headers: retHeader()
	});
...
export function getTeamReport(username, from, to) {
	const data = request({
		url: current + 'admin-api/record/teamReport?username=' + username + '&from=' + from + '&to=' + to,
		method: 'get',
		// data: postData,
		headers: retHeader()
	});
