    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "userKyc",
            component: () => import("./views/app/users/userKyc"),
            meta: { permission: '11' },
          },
          {
            path: "userKycHis",
            component: () => import("./views/app/users/userKycHis"),
            meta: { permission: '14' },
          },
          {
            path: "registerMember",
      ...
      },
      {
        ...
        component: () => import("./views/app/transaction"), //dashboard,
        meta: { permission: '1' },
        children: [
          {
            path: "record",
            component: () => import("./views/app/transaction/record"),
            meta: { permission: '13' },
          },
        ]
      },
      {
        ...
        children: [
          ...
          {
            path: "teamReport",
            component: () => import("./views/app/team/teamReport"),
            meta: { permission: '13' },
          },
        ]
      },
      {
        path: "/manage/package",
        component: () => import("./views/app/package"), //dashboard,
        children: [
          {
            path: "packageManage",
            component: () => import("./views/app/package/packageManage"),
            meta: { permission: '52' },
          },
          {
            path: "packageHis",
            component: () => import("./views/app/package/packageHis"),
          },
        ]
      },
      // //short
      // {
      //   path: "/manage/short",
      //   component: () => import("./views/app/short"),
      //   redirect: "/manage/short/shortManage",
      //   meta: { permission: '5' },
      //   children: [
      //   ]
      // },
      ...
      //insurance
      {
        ...
        redirect: "/manage/insurance/insuranceList",
        meta: { permission: '5' },
        children: [
          {
            path: "insuranceList",
            component: () => import("./views/app/insurance/insuranceList"),
            meta: { permission: '52' },
          },
          {
            path: "claimHis",
            component: () => import("./views/app/insurance/claimHis"),
            meta: { permission: '55' },
          },
          {
            path: "revertInsurance",
            component: () => import("./views/app/insurance/revertInsurance"),
            meta: { permission: '52' },
          },
          {
            path: "surrenderList",
            component: () => import("./views/app/insurance/surrenderList"),
            meta: { permission: '53' },
          },
          {
            path: "surrenderHis",
            component: () => import("./views/app/insurance/surrenderHis"),
            meta: { permission: '54' },
          },
        ]
      },
      ...
      //insurance
      {
        ...
        component: () => import("./views/app/follower"),
        redirect: "/manage/follower/followList",
        meta: { permission: '5' },
        children: [

          {
            path: "followList",
            component: () => import("./views/app/follower/followList"),
            meta: { permission: '53' },
          },
          {
            path: "unFollowList",
            component: () => import("./views/app/follower/unFollowList"),
            meta: { permission: '53' },
          },
          {
            path: "followerUserList",
            component: () => import("./views/app/follower/followerUserList"),
            meta: { permission: '53' },
          },
          {
            path: "followClaimList",
            component: () => import("./views/app/follower/followClaimList"),
            meta: { permission: '53' },
          },
        ]
      },
      ...
      //deposit
      {
        ...
        children: [
          ...
          {
            path: "reloadDeposit",
            component: () => import("./views/app/deposit/reloadDeposit"),
            meta: { permission: '42' },
          },
        ]
      },
...

      {
        ...
        children: [
          ...
          },
          {
            path: "level",
            meta: { permission: '81' },
            component: () => import("./views/app/record/level")
          },
          {
            path: "matching",
            meta: { permission: '82' },
