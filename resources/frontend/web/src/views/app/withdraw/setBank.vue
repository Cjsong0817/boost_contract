<template>
  <div class="main-content">
    ...
    >
      <b-form class="mx-5 mt-3" v-on:submit.prevent="_checkOTP">
        <b-row align-h="center">
          <b-col md="12">
            <b-input-group>
              <b-form-input
                class="form-control mb-3 form-custom2-prepend2"
                label="text"
                v-model="otp"
                type="text"
                :placeholder="$t('otp')"
