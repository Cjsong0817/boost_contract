<template>
  <div class="main-content auth-layout-wrap h-100 w-100 mx-auto">
    ...
    <b-form @submit.prevent="sendOTP">
      <div class="mainpage">
        <!-- <b-form-group :label="$t('username')" label-for="input-2">
          <b-form-input v-model="username" type="text" required></b-form-input>
        </b-form-group> -->
        <!-- <b-form-group :label="$t('country')" label-for="input-2">
          <div class="form-control mb-3" @click="openCountry()" id="demo">
            {{ $t("country") }}
          </div>
        </b-form-group> -->
        <b-form-group :label="$t('username')" label-for="input-2">
        ...
        <b-form-group :label="$t('vcode')" label-for="input-2" class="mb-4">
          <b-form-input
            class="form-custom"
            type="number"
            v-model="otp"
...
export default {
  ...
  methods: {
    ...
    sendOTP() {
      var self = this;
      var result = checkUsernameOtp(this.username, this.otp);
      self.isLoading = true;
    ...
    getOTP() {
      if (this.username == "") {
        ...
        formData.append("username", this.username);
        var result = usernameOTP(formData);
