  ...
  <div class="main-content">
    <div class="appBar">
      ...
      <span>{{ $t("settings") }}</span>
        ...
        <div class="mainpage">
            <b-card class="grey-card" @click="openLanguage()">
         ...
         <b-modal
          ...
          <b-container class="bv-example-row">
            <b-row @click="changeLang('en')">
              <b-col cols="1"><i class="header-icon-country"><flag iso="GB" /></i></b-col>
              <b-col cols="7" class="middle">{{ $t('en') }}</b-col>
            </b-row>
            <hr class="line"/>
            <b-row @click="changeLang('zh')">
              <b-col cols="1"><i class="header-icon-country"><flag iso="CN" /></i></b-col>
              <b-col cols="7" class="middle">{{ $t('zh') }}</b-col>
            </b-row>
          </b-container>
          </b-modal>
