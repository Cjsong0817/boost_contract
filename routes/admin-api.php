...
Route::group(['middleware' => ['jwt.auth', 'check-admin']], function () {
    ...
    Route::group(['prefix' => 'user'], function () {
        Route::post('/setProfit', [UserController::class, 'setProfit']);
    ...
    Route::group(['prefix' => 'project'], function () {
        Route::post('editQuit', [ProjectController::class, 'editQuit']);
        ...
        Route::get('quitHistory', [ProjectController::class, 'quitHistory']);
        ...
        Route::get('groupingRecord', [ProjectController::class, 'groupingRecord']);
        Route::post('grouping', [ProjectController::class, 'grouping']);
    });
...
//new api
    ...
    Route::group(['prefix' => 'news'], function () {
        ...
        Route::get('/popUpList', [NewsController::class, 'popUpList'])->name('popUpList');
        Route::post('/popUpControl', [NewsController::class, 'popUpControl'])->name('popUpControl');
        Route::get('/newsInfo', [NewsController::class, 'newsInfo'])->name('newsInfo');
        Route::get('/docList', [NewsController::class, 'docList'])->name('docList');
        Route::post('/docControl', [NewsController::class, 'docControl'])->name('docControl');
    });
